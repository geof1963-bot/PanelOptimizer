...
`PanelOptimizer Split Pipeline V6.00` and reports raw/sliver/structural counts
...
- Canonical seam branches and canonical dowel axes are reported and hard-
  validated for physical assembly.
