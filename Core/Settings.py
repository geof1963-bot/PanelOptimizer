...
class SplitSettings:
    ...
    MAX_CONNECTIVITY_REPAIR_ATTEMPTS: int = 12
    MAX_MULTI_ISLAND_REPAIR_STEPS: int = 12
    MAX_CONNECTIVITY_EXACT_VALIDATIONS: int = 12
    ...
    MAX_SLIVER_EFFECTIVE_FOOTPRINT_MM2: float = 75.0
    # Retained for backward-compatible diagnostics; not a classifier input.
